...
debug分支目前和main分支一样，后续可能在debug分支保留调试信息，在main分支删除调试信息提高性能（画饼中，还未实现……）
...
### 4. 查看截图
右键点击系统托盘中的应用程序图标，选择“查看”选项，将打开查看窗口。

-    **查看所有文件夹**：在查看窗口中，排列显示所有文件夹，显示进程图标和名称，方便查找
-    **查看文件夹内截图**：在查看窗口中，点击想要查看的文件夹，可以查看文件夹中的截图缩略图。
-    **查看截图**：点击想要查看的截图，可以放大显示截图，支持平移（鼠标左键）和放缩（鼠标滚轮）。
-    **返回上一级**：点击返回即可返回上一级。
...
需要注意，2.1版本后，ScreenShots文件夹中包含icon.png作为进程图标，使用查看功能不显示，但在文件夹查看时，不要惊慌，删了也没什么大问题，在截图后会尝试获取
